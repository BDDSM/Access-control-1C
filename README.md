...
# <p align="center">  🎉 Обработка перешла в статус **Open Source**!  </p>
...
>Инструмент находится в стабильном состоянии и решает широкий спектр практических задач. В связи с этим я принял решение завершить активную поддержку и открыть исходный код для свободного использования и доработок. 
