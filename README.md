...
<details>
 <summary><strong style="font-size: 1.7em;"> 💡 Новое в версии 4.5:</strong></summary>
<br>

- ✅ **Поиск роли** в поле «Выберите роль» — вводите имя или синоним, список сужается при наборе; выбор из подсказки или выпадающего списка.

![Поиск роли в поле выбора](docs/images/v4.5/role-search-autocomplete.png)

- ✅ **Сравнение ролей с главной формы** — для ролей, у которых есть права на выбранный объект метаданных (см. [как вызвать](#сравнение-ролей-с-главной-формы-45) ниже).
- ✅ Open-source сборка без ограничения «пробного периода».
- ✅ Исправления разбора журнала и совместимости с конфигурациями без константы Telegram.

#### Сравнение ролей с главной формы (4.5)

Это **не** сравнение произвольных ролей из шапки формы. Команда работает с таблицей **«Роли выбранного объекта»** справа (появляется после выбора объекта в дереве метаданных).

1. В **дереве метаданных** (центральная часть формы) выберите объект — справочник, документ, регистр и т.п.
2. Справа заполнится таблица ролей, у которых есть права на этот объект.
3. Выделите **не менее двух** строк: **Ctrl+клик** по нужным ролям или **Shift** для диапазона.
4. **Правый клик** по таблице → **«Сравнить роли»** — откроется форма сравнения с уже запущенным отчётом по метаданным.

![Сравнение ролей — контекстное меню таблицы](docs/images/v4.5/compare-roles-context-menu.png)

Чтобы сравнить **любые** роли конфигурации без привязки к объекту: **«Копирование / Сравнение / Настройки»** → вкладка **«Сравнение ролей»** → выбор ролей → **«Сравнить»** (подробнее в разделе [Сравнение ролей](#сравнение-ролей)).
