...
<div style="display: flex; justify-content: center; align-items: center; gap: 24px; flex-wrap: wrap; text-align: center;">
  
  <!-- ЛЕВАЯ ЧАСТЬ: Логотип -->
  <a href="https://github.com/VorozhbitDM/Access-control-1C/releases">
    <img src="https://i.ibb.co/yn7nkHPT/Access-Control-Logo.png" alt="Access Control Logo" width="200" style="vertical-align: middle;">
  </a>
